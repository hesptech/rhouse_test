          ...
          Container(
            ...
            child: Stack(
              children: [
                ...
                /* IconButton(
                  icon: Provider.of<FilterProvider>(context, listen: false).gameFavoritesTemp.contains(widget.listing.mlsNumber?? '')
                    ? const Icon(Icons.favorite, size: 30, color: Colors.white,)
                    : const Icon(Icons.favorite_border, size: 30, color: Colors.white,),
                  onPressed: () {
                    setState(() {
                      ...
                      toggle = !toggle;
                      if(toggle == true) {
                        Provider.of<FilterProvider>(context, listen: false).gameFavoritesTemp.add(widget.listing.mlsNumber?? '');
                      } else {
                        Provider.of<FilterProvider>(context, listen: false).gameFavoritesTemp.removeWhere((String name) => name == widget.listing.mlsNumber);
                      }
                      print(Provider.of<FilterProvider>(context, listen: false).gameFavoritesTemp);
                    });
                  }
                ), */
              ],
