      ...
      yield Padding(
        ...
        child: ChoiceChip(
          label: Container(
            ...
            child: Text(propertiesRooms.name, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: _defaultChoiceIndex == _propertiesRooms.indexOf(propertiesRooms) ? Colors.white : kPrimaryColor ), ),
          ),
